...
<body style="font-family: Georgia, serif; background: #FFF8F0; color: #1A1A1A; padding: 40px 20px;">
  <div style="max-width: 600px; margin: 0 auto; background: #FFFFFF; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
    <div style="background: #E85D04; padding: 32px; text-align: center;">
    ...
    <div style="padding: 40px 32px;">
      <h2 style="color: #E85D04; font-size: 22px; margin: 0 0 8px;">Demande reçue ✨</h2>
      ...
      <div style="background: #FFF8F0; border-radius: 10px; padding: 24px; margin-bottom: 24px;">
        <h3 style="color: #1A1A1A; font-size: 16px; margin: 0 0 16px; border-bottom: 1px solid #E85D04; padding-bottom: 8px;">
      ...
      <p style="color: #6B6B6B; font-size: 13px; margin: 0;">
        Si vous avez des questions, contactez-nous via Instagram <a href="https://www.instagram.com/mae_braided/" style="color: #E85D04;">@mae_braided</a>
      </p>
    </div>
...
<body style="font-family: sans-serif; padding: 32px; color: #1A1A1A;">
  <h2 style="color: #E85D04;">Nouvelle demande de réservation</h2>
...
<body style="font-family: Georgia, serif; background: #FFF8F0; color: #1A1A1A; padding: 40px 20px;">
  <div style="max-width: 600px; margin: 0 auto; background: #FFFFFF; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
    <div style="background: ${isConfirmed ? "#E85D04" : "#9B2226"}; padding: 32px; text-align: center;">
      <h1 style="color: white; font-size: 28px; margin: 0;">BraidedByMae</h1>
      <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 14px;">Artiste coiffeuse africaine à Nuremberg</p>
    </div>
    <div style="padding: 40px 32px;">
      <h2 style="color: ${isConfirmed ? "#E85D04" : "#9B2226"}; font-size: 22px; margin: 0 0 8px;">
      ...
      <p style="color: #6B6B6B; font-size: 13px; margin: 0;">
        Questions ? Instagram <a href="https://www.instagram.com/mae_braided/" style="color: #E85D04;">@mae_braided</a>
      </p>
    </div>
    <div style="background: #1A1A1A; padding: 20px 32px; text-align: center;">
